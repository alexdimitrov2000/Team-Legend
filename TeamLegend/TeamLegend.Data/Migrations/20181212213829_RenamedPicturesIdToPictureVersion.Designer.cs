...
namespace TeamLegend.Data.Migrations
{
    ...
    [Migration("20181212213829_RenamedPicturesIdToPictureVersion")]
    partial class RenamedPicturesIdToPictureVersion
    {
            ...
            modelBuilder.Entity("TeamLegend.Models.ApplicationUser", b =>
                {
                    b.HasOne("TeamLegend.Models.Team", "Team")
                        .WithOne("Manager")
                        .HasForeignKey("TeamLegend.Models.ApplicationUser", "TeamId");
                });
